...
import net.metrosystems.demo.base.TestBaseSetup;
...
public class AmazonTest extends TestBaseSetup {
	...
	String michaelKorsWatchStr = "Michael Kors Women" + "'" + "s Blair Chronograph Stainless Steel Watch"; // cum sa iei in considerare caracter '
	...
	public void amazonTest() throws InterruptedException {
		...
		for (int i = 0; i < 5; i++) {
			...
			case 3:
				...
				break;
			case 4:
				System.out.println(watches[3] + "price " + totalPriceString); // Y U NO SHOW
				break;
			}
		}
